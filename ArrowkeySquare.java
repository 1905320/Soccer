...
public class ArrowkeySquare extends Player implements Animatable
{
   private int dX;
   private int dY;
   ...
   {
      super(50, 50, 50, 540, Color.WHITE, "blueplayer.png" );
      dX = 0;
      dY = 0;
   }
   
   public ArrowkeySquare(int xsideValue, int ysideValue, int xValue, int yValue, Color cValue)
   {
      super(xsideValue, ysideValue, xValue, yValue, cValue, "redplayer.png");
      dX = 0;
      dY= 0;
   }
