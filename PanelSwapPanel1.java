...
class PanelSwapPanel1 extends JPanel
{
   ...
   public PanelSwapPanel1(JFrame f)
   {
...
{
   private PanelSwapPanel1 myOwner;  //The PanelSwapPanel that contains this panel (!)
   
   public SwapperOne(PanelSwapPanel1 p)
   {
